...
def validate_claims(output,errors):
 ...
 for claim in output.get('unsupportedClaimSignals',[]):
  ...
  if category in {'INSPECTION','APPROVAL','GENERATION','EXPORT','RELEASE'} and (not has_evidence or media in {'NOT_GENERATED','UNVERIFIED','NONE'}): issue(errors,'UNSUPPORTED_MEDIA_CLAIM',claim.get('text',''))
